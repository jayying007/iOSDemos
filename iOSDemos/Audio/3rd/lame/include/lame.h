 ...
 *
*/
int CDECL lame_encode_buffer(lame_global_flags *gfp, /* global context handle         */
 ...
 */
int CDECL lame_encode_buffer_interleaved(lame_global_flags *gfp, /* global context handlei        */
 ...
 * short int, +/- 32768
 */
int CDECL lame_encode_buffer_float(lame_global_flags *gfp, /* global context handle         */
 ...
 */
int CDECL lame_encode_buffer_ieee_float(lame_t gfp,
                                        const float pcm_l[], /* PCM data for left channel     */
                                        const float pcm_r[], /* PCM data for right channel    */
                                        const int nsamples,
                                        unsigned char *mp3buf,
                                        const int mp3buf_size);
int CDECL lame_encode_buffer_interleaved_ieee_float(lame_t gfp,
 ...
 * !! NOTE: !! data must be scaled to +/- 1 full scale
 */
int CDECL lame_encode_buffer_ieee_double(lame_t gfp,
                                         const double pcm_l[], /* PCM data for left channel     */
                                         const double pcm_r[], /* PCM data for right channel    */
                                         const int nsamples,
                                         unsigned char *mp3buf,
                                         const int mp3buf_size);
int CDECL lame_encode_buffer_interleaved_ieee_double(lame_t gfp,
 ...
 *
 */
int CDECL lame_encode_buffer_long(lame_global_flags *gfp, /* global context handle         */
 ...
 *
 */
int CDECL lame_encode_buffer_long2(lame_global_flags *gfp, /* global context handle         */
                                   const long buffer_l[], /* PCM data for left channel     */
                                   const long buffer_r[], /* PCM data for right channel    */
                                   const int nsamples, /* number of samples per channel */
                                   unsigned char *mp3buf, /* pointer to encoded MP3 stream */
 ...
 *
 */
int CDECL lame_encode_buffer_int(lame_global_flags *gfp, /* global context handle         */
...
void CDECL lame_bitrate_hist(const lame_global_flags *gfp, int bitrate_count[14]);
void CDECL lame_bitrate_kbps(const lame_global_flags *gfp, int bitrate_kbps[14]);
void CDECL lame_stereo_mode_hist(const lame_global_flags *gfp, int stereo_mode_count[4]);

void CDECL lame_bitrate_stereo_mode_hist(const lame_global_flags *gfp, int bitrate_stmode_count[14][4]);

void CDECL lame_block_type_hist(const lame_global_flags *gfp, int btype_count[6]);
 ...
 */
int CDECL lame_encode_finish(lame_global_flags *gfp, unsigned char *mp3buf, int size);
#endif
...
int CDECL hip_decode_headers(hip_t gfp, unsigned char *mp3buf, size_t len, short pcm_l[], short pcm_r[], mp3data_struct *mp3data);
...
int CDECL hip_decode1_headers(hip_t gfp, unsigned char *mp3buf, size_t len, short pcm_l[], short pcm_r[], mp3data_struct *mp3data);

/* same as hip_decode1_headers, but also returns enc_delay and enc_padding
   from VBR Info tag, (-1 if no info tag was found) */
int CDECL hip_decode1_headersB(
hip_t gfp, unsigned char *mp3buf, size_t len, short pcm_l[], short pcm_r[], mp3data_struct *mp3data, int *enc_delay, int *enc_padding);
...
int CDECL
lame_decode1_headersB(unsigned char *mp3buf, int len, short pcm_l[], short pcm_r[], mp3data_struct *mp3data, int *enc_delay, int *enc_padding);
