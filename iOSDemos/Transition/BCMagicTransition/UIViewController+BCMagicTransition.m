...
- (void)bc_viewDidAppear:(BOOL)animated {
    ...
    if (self.popTransit) {
        objc_setAssociatedObject(self, @"originNavigationDelegate", self.navigationController.delegate, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
- (void)bc_viewWillDisappear:(BOOL)animated {
    ...
    if (self.navigationController.delegate == self) {
        self.navigationController.delegate = objc_getAssociatedObject(self, @"originNavigationDelegate");
        objc_setAssociatedObject(self, @"originNavigationDelegate", nil, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
}
...
- (void)pushViewController:(UIViewController *)viewController fromView:(UIView *)fromView toView:(UIView *)toView duration:(NSTimeInterval)duration {
...
- (void)pushViewController:(UIViewController *)viewController
    ...
    UIScreenEdgePanGestureRecognizer *edgePanGestureRecognizer = [[UIScreenEdgePanGestureRecognizer alloc] initWithTarget:viewController
